...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <script src="depan/js/jquery-3.3.1.min.js"></script>
    <script src="depan/js/jquery-ui.js"></script>
    ...
    <script src="depan/js/jquery.countdown.min.js"></script>
    <script src="depan/js/jquery.easing.1.3.js"></script>
    <script src="depan/js/aos.js"></script>
    <script src="depan/js/jquery.fancybox.min.js"></script>
    <script src="depan/js/jquery.sticky.js"></script>
    <script src="depan/js/isotope.pkgd.min.js"></script>
